...
export const Illustrations = {
  ...
  hiddenPath: (
    <svg {...s}>
      ...
      <path
        d="M163 300 L237 300 L217 168 L183 168"
        fill="#B09878"
        opacity="0.35"
      />
      ...
      <path
        d="M22 100 Q67 62 112 100 Q122 178 112 300 L58 300 Q46 205 22 100"
        fill="#3B4537"
      />
      {/* Mid-distance trees right */}
      <rect x="324" y="105" width="18" height="195" rx="4" fill="#45392C" />
      <path
        d="M378 100 Q333 62 288 100 Q278 178 288 300 L342 300 Q354 205 378 100"
        fill="#3B4537"
      />
      {/* Foreground trees left — dark, large */}
      <rect x="-12" y="5" width="48" height="295" rx="6" fill="#3A2E22" />
      <path
        d="M-42 -8 Q18 -30 78 -8 Q98 85 78 300 L-12 300 Q-32 185 -42 -8"
        fill="#283020"
      />
      {/* Foreground trees right */}
      <rect x="364" y="5" width="48" height="295" rx="6" fill="#3A2E22" />
      <path
        d="M442 -8 Q382 -30 322 -8 Q302 85 322 300 L412 300 Q432 185 442 -8"
        fill="#283020"
      />
  ...
  treeMediation: (
    <svg {...s}>
      ...
      {/* Rolling ground */}
      <path
        d="M0 205 Q100 175 200 188 Q300 170 400 185 L400 300 L0 300"
        fill="#6A8A52"
      />
      <path
        d="M0 228 Q80 212 180 220 Q280 208 400 218 L400 300 L0 300"
        fill="#506840"
      />
      ...
      {/* Trunk — wide, ancient */}
      <path
        d="M174 300 Q168 245 163 182 Q166 152 200 142 Q234 152 237 182 Q232 245 226 300"
        fill="#5A4535"
      />
      <path
        d="M181 300 Q179 245 177 182 Q179 162 200 157 Q221 162 223 182 Q221 245 219 300"
        fill="#6B5545"
      />
      {/* Bark texture */}
      <path
        d="M184 238 Q182 208 184 178"
        fill="none"
        stroke="#45392C"
        strokeWidth="1.5"
        opacity="0.35"
      ...
      <path
        d="M200 38 Q242 18 278 44 Q315 28 322 68 Q342 80 332 112 Q348 132 326 148 Q332 172 312 168 Q302 188 280 177 Q266 198 246 184 Q232 202 212 190 Q200 202 188 190 Q168 202 154 184 Q134 177 120 168 Q98 172 104 148 Q82 132 98 112 Q88 80 108 68 Q115 28 160 44 Q172 20 200 38"
        fill="#3B4537"
      />
      {/* Inner canopy — lighter */}
      <path
        d="M200 62 Q228 48 254 64 Q276 55 278 80 Q294 90 282 112 Q288 128 272 134 Q268 148 250 140 Q240 152 222 144 Q212 154 200 148 Q188 154 178 144 Q160 152 150 140 Q132 134 118 112 Q106 90 122 80 Q124 55 146 64 Q170 48 200 62"
        fill="#4A6040"
      />
      {/* Canopy highlights */}
  ...
  waterConnection: (
    <svg {...s}>
      ...
      {/* Distant treeline */}
      <path
        d="M0 152 Q40 128 80 142 Q120 122 160 138 Q200 118 240 136 Q280 120 320 133 Q360 126 400 138 L400 168 L0 168"
        fill="#3B4537"
      />
      {/* Water surface */}
      <path
        d="M0 168 Q100 158 200 165 Q300 157 400 163 L400 300 L0 300"
        fill="#486464"
      />
      {/* Water colour variation — depth */}
      <path
        d="M0 220 Q100 210 200 216 Q300 208 400 214 L400 300 L0 300"
        fill="#3A5555"
      />
      {/* Shimmer lines */}
      <path
        d="M48 184 Q82 180 116 184"
        fill="none"
        stroke="#6A8888"
        strokeWidth="1.5"
        opacity="0.55"
  ...
  wildlifeSpotting: (
    <svg {...s}>
      ...
      {/* Distant hills */}
      <path
        d="M0 178 Q80 140 160 162 Q240 135 320 158 Q360 145 400 154 L400 300 L0 300"
        fill="#7A9B5A"
      />
      <path
        d="M0 208 Q60 192 130 203 Q200 188 270 200 Q340 192 400 198 L400 300 L0 300"
        fill="#5A7A4A"
      />
      ...
      <path
        d="M8 125 Q35 102 62 125 Q68 172 62 210 L28 210 Q20 178 8 125"
        fill="#3B4537"
      />
      <rect x="352" y="118" width="15" height="92" rx="3" fill="#45392C" />
      <path
        d="M328 115 Q360 90 392 115 Q400 167 392 210 L352 210 Q342 172 328 115"
        fill="#3B4537"
      />
      <rect x="298" y="138" width="12" height="72" rx="3" fill="#45392C" />
      <path
        d="M278 135 Q304 114 330 135 Q336 174 330 210 L298 210 Q290 178 278 135"
        fill="#4A6040"
      />
      {/* Deer silhouette */}
      <ellipse cx="218" cy="220" rx="30" ry="17" fill="#6B5040" />
      <path
        d="M230 207 Q238 194 236 180"
        fill="none"
        stroke="#6B5040"
        strokeWidth="13"
        strokeLinecap="round"
      ...
      {/* Butterfly */}
      <path
        d="M143 192 Q136 181 143 186 Q150 181 143 192"
        fill="#855119"
        opacity="0.82"
      />
      <path
        d="M143 192 Q136 201 143 196 Q150 201 143 192"
        fill="#C87A30"
        opacity="0.82"
      />
  ...
  barefootWalking: (
    <svg {...s}>
      ...
      {/* Grass layer */}
      <path
        d="M0 185 Q100 172 200 179 Q300 170 400 177 L400 205 L0 205"
        fill="#3B4537"
      />
      {/* Grass blades — manual for perf */}
      <path
        d="M5 200 Q3 182 7 168"
        fill="none"
        stroke="#506840"
        strokeWidth="2.2"
        strokeLinecap="round"
      ...
      {/* Left foot */}
      <path
        d="M108 252 Q106 215 120 204 Q146 196 162 208 Q170 217 167 252 L108 252"
        fill="#C8A880"
      />
      ...
      {/* Right foot */}
      <path
        d="M232 262 Q230 222 244 210 Q270 201 286 215 Q295 224 291 262 L232 262"
        fill="#C8A880"
      />
  ...
  cloudWatching: (
    <svg {...s}>
      ...
      {/* Main large cloud */}
      <path
        d="M155 88 Q160 62 186 66 Q192 48 218 52 Q242 44 254 62 Q272 56 274 74 Q287 76 285 92 Q287 106 272 103 Q266 116 248 111 Q238 122 220 116 Q208 126 192 118 Q176 124 168 112 Q150 114 148 98 Q136 96 140 84 Q138 72 155 88"
        fill="white"
        opacity="0.96"
      />
      {/* Cloud inner shadow */}
      <path
        d="M156 96 Q165 88 192 92 Q222 86 256 90 Q270 90 270 100"
        fill="none"
        stroke="#C5DCEE"
        strokeWidth="3"
        opacity="0.45"
      ...
      {/* Right cloud */}
      <path
        d="M292 58 Q298 44 316 47 Q328 40 340 50 Q354 46 354 60 Q362 64 359 74 Q354 82 340 80 Q332 88 320 83 Q308 87 302 79 Q290 78 290 68 Q286 60 292 58"
        fill="white"
        opacity="0.9"
      />
      {/* Left cloud */}
      <path
        d="M46 102 Q52 88 66 91 Q74 82 90 86 Q100 82 102 92 Q110 94 108 104 Q104 112 94 110 Q88 116 77 112 Q66 116 60 109 Q48 108 46 100"
        fill="white"
        opacity="0.85"
      />
      {/* Wispy upper right */}
      <path
        d="M332 32 Q343 25 358 28 Q370 22 375 32 Q384 32 381 41 Q375 46 364 44 Q354 48 344 44 Q332 44 330 37"
        fill="white"
        opacity="0.68"
      />
      {/* Wispy upper left */}
      <path
        d="M28 55 Q36 48 50 50 Q60 44 66 52 Q74 52 72 60 Q66 64 56 62 Q48 66 40 62 Q28 62 26 56"
        fill="white"
        opacity="0.6"
      />
      {/* Grass framing bottom of scene */}
      <path
        d="M0 268 Q100 253 200 260 Q300 250 400 258 L400 300 L0 300"
        fill="#3B4537"
      />
      <path
        d="M0 283 Q80 273 160 279 Q240 269 320 277 Q360 272 400 275 L400 300 L0 300"
        fill="#2A3525"
      />
      {/* Grass blades at edges */}
      <path
        d="M0 268 Q3 250 6 237"
        fill="none"
        stroke="#506840"
        strokeWidth="2.5"
        strokeLinecap="round"
      ...
      <path
        d="M118 278 Q162 270 244 274 Q265 275 272 281 Q250 284 230 282 Q162 279 118 278"
        fill="#855119"
      />
      {/* Head */}
  ...
  naturalColorsHunt: (
    <svg {...s}>
      ...
      {/* Meadow layers */}
      <path
        d="M0 182 Q100 160 200 172 Q300 156 400 168 L400 300 L0 300"
        fill="#7A9B5A"
      />
      <path
        d="M0 210 Q100 196 200 203 Q300 193 400 200 L400 300 L0 300"
        fill="#5A7A4A"
      />
      <path
        d="M0 236 Q100 225 200 230 Q300 222 400 228 L400 300 L0 300"
        fill="#3B4537"
      />
      {/* Subtle arc guide (dashed, white) */}
      <path
        d="M138 152 Q155 118 172 106 Q186 96 200 93 Q214 96 228 106 Q246 118 262 152"
        fill="none"
        stroke="white"
        strokeWidth="1.2"
        opacity="0.35"
      ...
      <path
        d="M172 106 Q184 111 188 121 Q184 132 172 135 Q160 132 156 121 Q160 111 172 106"
        fill="#D46020"
      />
      <line
        x1="172"
      ...
      />
      <path
        d="M172 112 L162 118 M172 118 L163 124 M172 124 L162 130"
        fill="none"
        stroke="#855119"
        strokeWidth="1"
        opacity="0.5"
      />
      <path
        d="M172 112 L182 118 M172 118 L181 124 M172 124 L182 130"
        fill="none"
        stroke="#855119"
        strokeWidth="1"
        opacity="0.5"
      ...
      <ellipse
        ...
        rx="4.5"
        ry="3.5"
        transform="rotate(-45 211 116)"
        fill="#F0D840"
      />
      {/* GREEN — fresh leaf */}
      <circle cx="228" cy="118" r="24" fill="#3B8020" opacity="0.1" />
      <path
        d="M228 106 Q242 111 246 122 Q242 134 228 138 Q218 135 216 122 Q220 111 228 106"
        fill="#5A8A3A"
      />
      <line
        x1="228"
      ...
      />
      <path
        d="M228 112 L218 118 M228 120 L220 126 M228 128 L219 133"
        fill="none"
        stroke="#3B6020"
        strokeWidth="1"
        opacity="0.5"
      />
      <path
        d="M228 112 L238 118 M228 120 L236 126 M228 128 L237 133"
        fill="none"
        stroke="#3B6020"
        strokeWidth="1"
        opacity="0.5"
  ...
  sunsetWalk: (
    <svg {...s}>
      ...
      <path
        d="M0 42 Q200 30 400 42 L400 125 L0 125"
        fill="#2A5080"
        opacity="0.9"
      />
      <path
        d="M0 90 Q200 75 400 90 L400 150 L0 150"
        fill="#5A4A38"
        opacity="0.85"
      />
      ...
      <path
        d="M168 172 Q200 177 232 172 L228 300 L172 300"
        fill="#D4A030"
        opacity="0.2"
      />
      {/* Ground */}
      ...
      <path
        d="M0 172 Q100 167 200 170 Q300 165 400 168 L400 205 L0 205"
        fill="#3B4537"
      />
      <path
        d="M0 198 Q100 190 200 194 Q300 187 400 192 L400 220 L0 220"
        fill="#2A3525"
      />
      {/* Tree silhouettes */}
      <path
  ...
  stoneStack: (
    <svg {...s}>
      ...
      {/* Clouds */}
      <path
        d="M48 65 Q58 52 76 56 Q86 45 102 51 Q114 46 116 58 Q125 60 122 70 Q118 78 105 76 Q97 83 84 79 Q73 83 64 76 Q50 74 48 66"
        fill="white"
        opacity="0.88"
      />
      <path
        d="M298 48 Q310 38 326 41 Q340 34 350 42 Q362 38 362 50 Q370 54 367 63 Q361 70 349 68 Q341 74 329 70 Q318 74 310 68 Q296 66 294 56"
        fill="white"
        opacity="0.82"
      />
      <path
        d="M168 32 Q174 24 186 26 Q194 20 202 25 Q210 21 210 30 Q216 32 213 40 Q208 46 200 44 Q194 48 186 45 Q178 48 172 44 Q162 42 161 35"
        fill="white"
        opacity="0.7"
      />
      {/* Distant hills */}
      <path
        d="M0 202 Q80 168 160 182 Q240 162 320 178 Q360 168 400 174 L400 300 L0 300"
        fill="#7A9B5A"
      />
      <path
        d="M0 222 Q80 206 160 213 Q240 202 320 209 Q360 203 400 207 L400 300 L0 300"
        fill="#5A7A4A"
      />
      {/* Rocky ground */}
      <path
        d="M0 258 Q100 250 200 254 Q300 248 400 252 L400 300 L0 300"
        fill="#6A6058"
      />
      <path
        d="M0 270 Q100 264 200 267 Q300 261 400 265 L400 300 L0 300"
        fill="#7A7068"
      />
      <path
        d="M0 280 Q100 274 200 277 Q300 271 400 275 L400 300 L0 300"
        fill="#8A8078"
      />
      {/* Ground pebbles */}
      ...
      {/* Base stone */}
      <path
        d="M153 264 Q200 254 247 262 Q250 271 200 276 Q150 271 153 264"
        fill="#5A5550"
      />
      <ellipse cx="200" cy="264" rx="47" ry="6" fill="#8A8580" />
      {/* Stone 2 */}
      <path
        d="M162 254 Q200 244 238 252 Q240 261 200 265 Q160 261 162 254"
        fill="#5A5248"
      />
      <ellipse cx="200" cy="254" rx="38" ry="5.5" fill="#7E7A74" />
      {/* Stone 3 — slight angle */}
      <path
        d="M168 244 Q203 235 235 242 Q237 250 203 254 Q168 250 168 244"
        fill="#6A6258"
      />
      <ellipse cx="201" cy="244" rx="34" ry="5" fill="#7A7268" />
      {/* Stone 4 — rounder */}
      <path
        d="M174 231 Q200 222 228 229 Q232 239 200 243 Q170 239 174 231"
        fill="#5A5550"
      />
      <ellipse cx="200" cy="231" rx="28" ry="5" fill="#7E7A74" />
      {/* Stone 5 */}
      <path
        d="M179 220 Q200 211 222 218 Q225 227 200 230 Q177 227 179 220"
        fill="#5A5248"
      />
      <ellipse cx="200" cy="220" rx="23" ry="4.5" fill="#726E68" />
      {/* Stone 6 */}
      <path
        d="M183 210 Q200 201 218 208 Q220 215 200 219 Q181 215 183 210"
        fill="#6A6258"
      />
      <ellipse cx="200" cy="210" rx="19" ry="4" fill="#7A7670" />
      {/* Stone 7 — narrower */}
      <path
        d="M186 200 Q200 192 215 198 Q217 206 200 209 Q184 206 186 200"
        fill="#5A5248"
      />
      <ellipse cx="200" cy="200" rx="15.5" ry="3.8" fill="#726E68" />
      {/* Capstone */}
      <path
        d="M190 190 Q200 183 211 188 Q213 196 200 199 Q188 196 190 190"
        fill="#5A5248"
      />
      <ellipse cx="200" cy="190" rx="12" ry="3.2" fill="#827E78" />
      {/* Tiny top stone */}
      <path
        d="M193 181 Q200 175 208 179 Q210 186 200 188 Q191 186 193 181"
        fill="#6A6258"
      />
  ...
  natureSounds: (
    <svg {...s}>
      ...
      <path
        d="M22 55 Q58 28 94 55 Q108 138 94 300 L48 300 Q34 200 22 55"
        fill="#2A3525"
      />
      <rect x="332" y="55" width="20" height="245" rx="4" fill="#3A2E22" />
      <path
        d="M306 50 Q342 23 378 50 Q392 138 378 300 L332 300 Q318 195 306 50"
        fill="#2A3525"
      />
      <rect x="128" y="100" width="16" height="200" rx="3" fill="#45392C" />
      <path
        d="M106 95 Q136 70 166 95 Q178 165 166 300 L128 300 Q116 200 106 95"
        fill="#3B4537"
      />
      <rect x="258" y="95" width="16" height="205" rx="3" fill="#45392C" />
      <path
        d="M234 90 Q266 63 298 90 Q310 160 298 300 L258 300 Q246 195 234 90"
        fill="#3B4537"
      />
      ...
      {/* Hair */}
      <path
        d="M184 186 Q192 174 200 172 Q208 174 216 186 Q212 179 200 177 Q188 179 184 186"
        fill="#45392C"
      />
      {/* Arms open wide — receptive, listening */}
      <path
        d="M188 212 Q174 218 162 229"
        fill="none"
        stroke="#855119"
        strokeWidth="8"
        strokeLinecap="round"
  ...
  hillClimb: (
    <svg {...s}>
      ...
      {/* Clouds */}
      <path
        d="M58 72 Q68 58 88 62 Q98 52 114 58 Q124 53 126 64 Q135 66 132 77 Q127 86 114 84 Q106 91 93 87 Q81 91 72 84 Q57 82 56 73"
        fill="white"
        opacity="0.9"
      />
      <path
        d="M282 52 Q294 41 310 44 Q323 37 334 46 Q346 42 347 54 Q355 58 352 67 Q346 74 334 72 Q326 78 314 74 Q303 78 295 72 Q281 70 279 60"
        fill="white"
        opacity="0.85"
      />
      <path
        d="M158 36 Q166 28 180 31 Q188 24 197 29 Q205 25 205 35 Q212 37 209 44 Q204 50 196 48 Q190 52 181 49 Q173 52 167 48 Q157 46 156 38"
        fill="white"
        opacity="0.72"
      />
      {/* Distant misty hills */}
      <path
        d="M0 185 Q60 152 130 168 Q200 148 270 164 Q335 150 400 160 L400 225 L0 225"
        fill="#7A9870"
        opacity="0.55"
      />
      {/* Mid hills */}
      <path
        d="M0 202 Q50 172 122 185 Q192 168 254 182 Q325 166 400 176 L400 245 L0 245"
        fill="#6A8A5A"
      />
      {/* Main hero hill */}
      <path
        d="M0 285 Q0 245 82 202 Q154 166 200 156 Q246 166 282 193 Q345 224 400 248 L400 300 L0 300"
        fill="#3B4537"
      />
      {/* Lit face of the hill */}
      <path
        d="M0 285 Q0 255 62 218 Q122 182 200 158 Q210 163 222 172 Q200 178 175 190 Q120 212 82 245 Q42 268 0 288"
        fill="#4A5C3F"
      />
      {/* Trail/path up the hill */}
      <path
        d="M0 298 Q52 280 105 256 Q158 226 185 195"
        fill="none"
        stroke="#6B5040"
        strokeWidth="3"
        strokeDasharray="8 5"
      ...
      {/* Summit grass */}
      <path
        d="M184 158 Q200 149 216 157 Q218 164 200 167 Q182 164 184 158"
        fill="#5A7A4A"
      />
      {/* Summit rocks */}
  ...
  leafCollection: (
    <svg {...s}>
      ...
      <g transform="translate(88, 158) rotate(-18)">
        <path
          d="M22 65 Q17 50 6 42 Q17 42 22 50 Q22 33 11 22 Q22 27 27 38 Q24 19 30 8 Q34 21 32 37 Q38 22 47 18 Q42 32 38 43 Q45 33 54 34 Q48 44 38 47 Q46 54 44 65 Q33 60 22 65 Q11 60 20 65"
          fill="#C83028"
        />
        <line
          x1="22"
        ...
        />
        <path
          d="M22 65 L11 49 M22 65 L30 46 M22 65 L38 55"
          fill="none"
          stroke="#A82020"
          strokeWidth="1.2"
          opacity="0.55"
      ...
      <g transform="translate(172, 112) rotate(12)">
        <path
          d="M17 0 Q11 13 5 16 Q11 16 17 13 Q11 22 6 27 Q14 26 18 21 Q13 30 8 36 Q18 34 22 28 Q20 37 22 45 Q24 37 26 28 Q30 34 40 36 Q35 30 30 21 Q34 26 42 27 Q37 22 31 13 Q37 16 43 16 Q37 13 31 0 Q26 16 24 19 Q21 13 17 0"
          fill="#D4A030"
        />
        <line
          x1="22"
        ...
        />
        <path
          d="M22 26 L11 20 M22 26 L33 20 M22 36 L9 30 M22 36 L35 30"
          fill="none"
          stroke="#B88022"
          strokeWidth="1"
          opacity="0.48"
      ...
      <g transform="translate(268, 120) rotate(-10)">
        <path
          d="M26 0 Q10 6 5 19 Q2 30 5 37 Q10 44 26 48 Q42 44 46 37 Q50 30 46 19 Q41 6 26 0"
          fill="#E8C020"
        />
        {/* Fan veins */}
        <line
      ...
      <g transform="translate(34, 195) rotate(22)">
        <path
          d="M16 0 Q32 6 36 22 Q33 37 16 47 Q-1 37 1 22 Q6 6 16 0"
          fill="#5A8040"
        />
        <line
          x1="16"
        ...
        />
        <path
          d="M16 14 L5 22 M16 14 L27 22 M16 26 L4 34 M16 26 L28 34"
          fill="none"
          stroke="#3B6028"
          strokeWidth="1"
          opacity="0.48"
      ...
      <g transform="translate(330, 188) rotate(-28)">
        <path
          d="M11 0 Q22 9 24 24 Q22 38 11 47 Q0 38 2 24 Q4 9 11 0"
          fill="#9ABB42"
        />
        <line
          x1="11"
        ...
        />
        <path
          d="M11 12 L4 18 M11 20 L4 26 M11 28 L4 34 M11 36 L5 42"
          fill="none"
          stroke="#6A8828"
          strokeWidth="0.8"
          opacity="0.45"
        />
        <path
          d="M11 12 L18 18 M11 20 L18 26 M11 28 L18 34 M11 36 L17 42"
          fill="none"
          stroke="#6A8828"
          strokeWidth="0.8"
          opacity="0.45"
      ...
      {/* Small fallen petals */}
      <path
        d="M28 282 Q33 276 38 282 Q33 288 28 282"
        fill="#C83028"
        opacity="0.55"
      />
      <path
        d="M358 275 Q363 269 368 275 Q363 281 358 275"
        fill="#D4A030"
        opacity="0.5"
      />
      <path
        d="M200 290 Q205 285 210 290 Q205 295 200 290"
        fill="#5A8040"
        opacity="0.5"
      />
    </svg>
